  ...
  return (
    <footer id="contato" className="relative bg-navy text-white overflow-hidden">
      <div
        ...
        style={{ background: 'radial-gradient(ellipse 50% 60% at 100% 50%, rgba(201,167,104,0.06), transparent 70%)' }}
      />
      ...
      <div className="relative mx-auto max-w-[1280px] px-6 md:px-10 pt-14 md:pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-5">
            ...
            <ul className="mt-6 space-y-3 text-white/85 text-[14px]">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+5581999957001" className="hover:text-gold transition-colors">(81) 9 9995-7001</a>
              </li>
              <li className="flex items-center gap-3">
                <Icon name="phone" className="w-4 h-4 text-gold shrink-0" stroke={1.7} />
                <a href="tel:+558134232388" className="hover:text-gold transition-colors">(81) 3423-2388</a>
              </li>
              <li className="flex items-center gap-3">
                <Icon name="mail" className="w-4 h-4 text-gold shrink-0" stroke={1.7} />
                <a href="mailto:marinaswindshop@hotmail.com" className="hover:text-gold transition-colors">
          ...
          <div className="md:col-span-4">
            ...
            <a
              ...
              className="mt-5 inline-flex items-center gap-3 h-[48px] px-6 rounded-ds bg-gold hover:bg-[#b8954f] active:translate-y-[1px] transition-all text-navy text-[12px] font-semibold tracking-wider-2 shadow-soft"
            >
            ...
            <div className="mt-3 flex items-center gap-3">
              <a
                ...
                className="w-9 h-9 rounded-full border border-white/35 grid place-items-center hover:border-gold hover:text-gold transition-colors"
              >
          ...
          <div className="md:col-span-3">
            <p className="text-gold text-[11px] tracking-wider-3 font-medium">ONDE NOS ENCONTRAR</p>
            ...
            <a
              ...
              className="mt-3 group inline-flex items-center gap-2 text-gold hover:text-[#dcc183] text-[11.5px] font-semibold tracking-wider-2 transition-colors"
            >
              COMO CHEGAR
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col md:flex-row items-center md:items-center gap-6 md:gap-4">
          ...
          <a
            href="#planeje"
            className="inline-flex items-center gap-2 h-[44px] px-6 rounded-ds bg-gold hover:bg-[#b8954f] text-navy text-[12px] font-semibold tracking-wider-2 transition-colors"
          >
            PLANEJE SUA VISITA
          </a>
        </div>
